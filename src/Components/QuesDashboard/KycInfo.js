        ...
        try {
            let valrequired = {
              ...
              await axios.post(env.apiUrl + 'api/teleservice/kyc-information/',valrequired,
              {
                ...
                setlivelinessScoreVKYC(res.data.response[1].live_ness_score)
                setisCustomerInIndia(res.data.response[1].is_cutomer_in_india)
                setadharStatus(res.data.response[1].aadhar_status)
                setvkycGeoLocationLAT(res.data.response[1].vkyc_geo_location_lat)
                setadharMatchScore(res.data.response[1].aadhar_match_score)
                setvkycGeoLocationLONG(res.data.response[1].vkyc_geo_location_long)
                setpanStatus(res.data.response[1].pan_status)
                setnameMatch(res.data.response[1].name_match)
                setpanMatchScore(res.data.response[1].pan_match_score)
                setallMatch(res.data.response[1].all_match)
                setOTPstatusAgentDecision(res.data.response[1].otp_status_agent_decision)
                setKYCStatus(res.data.response[1].kyc_status)
                setfaceDetectionVerifiedByAgent(res.data.response[1].face_detection_verified_by_agent)
                setselfieUploadDateTimeVKYC(res.data.response[1].kyc_response)
