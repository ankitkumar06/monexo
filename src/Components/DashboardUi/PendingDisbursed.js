        ...
        {headCells.map((headCell) => (
          ...
          >
            ...
            //   disabled={true ? headCell.id== 'App_ID' || headCell.id== 'Call' || headCell.id== 'Cust Name': false}
              active={headCell.id=='customer_id' ||  headCell.id== 'loan_app_id' ||  headCell.id== 'approved_dt' ||  headCell.id== 'funded_dt' ||   headCell.id== 'loan_amt'|| headCell.id== 'date' ||   headCell.id== 'email_verified'||   headCell.id== 'ev_kyc' ||   headCell.id== 'e_nach' ||  headCell.id== 'phone_num' || orderBy === headCell.id }
            //   
...
export default function PendingDisbursed(props ,{parentCallback}) {
//  const {setData} =props;
